...
@section('styles')
<style>
    .inv-card{border:0;border-radius:14px;box-shadow:0 4px 20px rgba(15,23,42,.08);}
    .inv-header{background:linear-gradient(135deg,#1e293b,#334155);border-radius:14px 14px 0 0;padding:28px 32px;color:#fff;}
    .inv-header h3{font-weight:800;letter-spacing:-.3px;}
    .inv-header .meta{opacity:.7;font-size:13px;}

    .info-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px 30px;padding:22px 28px;}
    .info-grid .lbl{font-size:11px;font-weight:700;letter-spacing:.5px;text-transform:uppercase;color:#64748b;margin-bottom:3px;}
    .info-grid .val{font-size:14px;font-weight:600;color:#1e293b;}

    .items-table thead th{background:#f1f5f9;color:#1e293b;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.4px;border-bottom:2px solid #e2e8f0;}
    .items-table tbody td{font-size:13px;vertical-align:middle;border-color:#f1f5f9;}
    .items-table tfoot td{background:#1e293b;color:#fff;font-size:14px;font-weight:700;}
            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
                ...
                <div class="text-end">
                    @if($invoice->status === 'confirmed')
                        <span style="background:rgba(34,197,94,.2);color:#86efac;padding:6px 18px;border-radius:20px;font-size:12px;font-weight:700;letter-spacing:.5px;">
                            ✓ CONFIRMED
                        </span>
                    @elseif($invoice->status === 'cancelled')
                        <span style="background:rgba(239,68,68,.2);color:#fca5a5;padding:6px 18px;border-radius:20px;font-size:12px;font-weight:700;">
                            ✗ CANCELLED
                        </span>
                    @else
                        <span style="background:rgba(234,179,8,.2);color:#fde047;padding:6px 18px;border-radius:20px;font-size:12px;font-weight:700;">
                            DRAFT
                        </span>
                    @endif
                </div>
