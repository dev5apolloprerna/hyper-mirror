...
@section('styles')
<style>
    .stat-card{background:#fff;border:1px solid #e8edf5;border-radius:12px;padding:18px 22px;box-shadow:0 2px 10px rgba(15,23,42,.05);}
    .stat-card .lbl{font-size:11px;font-weight:700;letter-spacing:.5px;text-transform:uppercase;color:#64748b;margin-bottom:5px;}
    .stat-card .val{font-size:26px;font-weight:800;color:#1e293b;line-height:1;}
    .filter-bar{background:#fff;border:1px solid #e8edf5;border-radius:12px;padding:18px;box-shadow:0 2px 8px rgba(15,23,42,.04);}
    .inv-table thead th{background:#1e293b;color:#fff;font-size:12px;font-weight:600;white-space:nowrap;border-color:#334155;vertical-align:middle;}
    .inv-table tbody tr:hover{background:#f8faff;}
    .inv-table tbody td{font-size:13px;vertical-align:middle;}
            ...
            <div class="row g-2 align-items-end">
                <div class="col-md-3">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}"
                        class="form-control form-control-sm" placeholder="Invoice no / showroom">
                </div>
                <div class="col-md-2">
