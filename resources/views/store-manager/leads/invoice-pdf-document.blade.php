...
<head>
    <meta charset="UTF-8">
    <title>Invoice {{ $lead->strLeadNo }}</title>
    <style>
        @page {
            margin: 24px;
        }
...
<body>
    ...
    <div class="doc-subtitle">Invoice Document</div>
</div>
        ...
        <table class="party-table">
            <tr>
                ...
                <td>
                    ...
                    <!-- <div><strong>Accountant Name:</strong>
                        {{ optional($branchAccountUser)->full_name ?: (optional($branchAccountUser)->strUserName ?: (optional($branchAccountUser)->first_name ?? '—')) }}
                    </div> -->
                    <div><strong>Accountant Mobile:</strong> 7575002108</div>
    ...
    {{-- @if (!$canViewFinancial)
        <div class="notice">
            This invoice includes only product, measurement, and quantity details. Pricing columns are hidden for your access level.
        </div>
    @endif --}}
        ...
        <tr>
            <td class="terms-cell">
                ...
                <div class="detail-body">
                    ...
                    @else
                        <ol>
                            <li>Prices are valid for 7 days from the invoice date.</li>
