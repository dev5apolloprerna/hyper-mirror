    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <a href="{{ route('Paymentcollection.index') }}" class="btn btn-primary btn-sm">
                ...
                <div class="card">
                    <div class="card-body">
                    <form action="{{ route('Paymentcollection.Store') }}" method="POST" id="paymentCollectionForm">
                            @csrf
                            <div class="row">
                                <!-- User Dropdown -->
                                <div class="col-md-6 mb-4">
                                    ...
                                    <small id="availableAmountText" class="text-primary d-block mt-2">
                                        Accountant Closing Balance: ₹0.00
                                    </small>
                                </div>
                                <!-- Amount -->
                                <div class="col-md-6 mb-4">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const resetAmountDisplay = () => {
            ...
            availableAmountText.innerText = 'Accountant Closing Balance: ₹0.00';
        ...
        const validateAmount = () => {
            ...
            if (enteredAmount > availableAmount && availableAmount >= 0) {
                amountValidationError.innerText =
                    `Amount cannot be greater than accountant closing balance (₹${availableAmount.toFixed(2)}).`;
        ...
        userSelect.addEventListener('change', async function() {
            ...
            try {
                const response = await fetch(`{{ url('admin/available-amount') }}/${userId}`);
                const data = await response.json();
                availableAmount = parseFloat(data.available_amount || 0);
                amountInput.setAttribute('max', availableAmount.toFixed(2));
                availableAmountText.innerText = `Accountant Closing Balance: ₹${availableAmount.toFixed(2)}`;
                validateAmount();
            } catch (error) {
                resetAmountDisplay();
            }
