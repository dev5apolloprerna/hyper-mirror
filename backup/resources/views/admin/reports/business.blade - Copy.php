                ...
                <div class="col-lg-5">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header bg-white d-flex align-items-center justify-content-between">
                            ...
                            <small class="text-muted">Business done, due and received by showroom</small>
                         </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            <th>Showroom</th>
                                            <th class="text-end">Quotation Done</th>
                                            <th class="text-end">Quotation Due</th>
                                            <th class="text-end">Quotation Received</th>
                                            <th class="text-end">Invoice Done</th>
                                            <th class="text-end">Invoice Due</th>
                                            <th class="text-end">Invoice Received</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @forelse($showroomWiseBusiness as $row)
                                            <tr>
                                                ...
                                                <td class="text-end">₹{{ number_format((float)($row->quotation_done ?? 0), 2) }}</td>
                                                <td class="text-end text-warning">₹{{ number_format((float)($row->quotation_due ?? 0), 2) }}</td>
                                                <td class="text-end text-success">₹{{ number_format((float)($row->quotation_received ?? 0), 2) }}</td>
                                                <td class="text-end">₹{{ number_format((float)($row->invoice_done ?? 0), 2) }}</td>
                                                <td class="text-end text-warning">₹{{ number_format((float)($row->invoice_due ?? 0), 2) }}</td>
                                                <td class="text-end text-success">₹{{ number_format((float)($row->invoice_received ?? 0), 2) }}</td>
                                            </tr>
                                        @empty
                                    ...
                                    <tfoot class="table-success">
                                        <tr>
                                            ...
                                            <td class="text-end"><strong>₹{{ number_format($showroomWiseBusiness->sum('quotation_done'), 2) }}</strong></td>
                                            <td class="text-end"><strong>₹{{ number_format($showroomWiseBusiness->sum('quotation_due'), 2) }}</strong></td>
                                            <td class="text-end"><strong>₹{{ number_format($showroomWiseBusiness->sum('quotation_received'), 2) }}</strong></td>
                                            <td class="text-end"><strong>₹{{ number_format($showroomWiseBusiness->sum('invoice_done'), 2) }}</strong></td>
                                            <td class="text-end"><strong>₹{{ number_format($showroomWiseBusiness->sum('invoice_due'), 2) }}</strong></td>
                                            <td class="text-end"><strong>₹{{ number_format($showroomWiseBusiness->sum('invoice_received'), 2) }}</strong></td>
                                        </tr>
                                    </tfoot>
                                    @endif
                                </table>
