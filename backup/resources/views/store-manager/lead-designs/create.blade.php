...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div>
                            <h4 class="mb-sm-0">Add Lead Design</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('store.leads.designs.store', $lead->iLeadId) }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <label class="form-label">Title</label>
                                <input type="text" name="strTitle" class="form-control" value="{{ old('strTitle') }}" placeholder="Enter design title">
                            ...
                            <div class="col-md-6 mb-4">
                                <label class="form-label">Design File <span style="color:red;">*</span></label>
